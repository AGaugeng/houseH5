 ...
 * @LastEditors: Song
 * @LastEditTime: 2018-12-18 11:01:48
...
class Counter extends Component {
  ...
  getResoldCollection() {
    this.props.getResoldCollection([
  ...
  collection = (item) => {
    ...
    return (
      <Collection
        ...
        houseList={() => {
          this.props.navigation.navigate("ResoldHouseDetail", item)
        }}
...
const mapStateToProps = state => ({
  collection: state.user.resoldcollect,
  token: state.user.token,
})

export default connect(mapStateToProps, { getResoldCollection })(Counter)
