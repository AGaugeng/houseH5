 ...
 * @LastEditors: Song
 * @LastEditTime: 2018-12-18 13:37:10
 * @Description: 合同管理-出售
 */
...
import { List, Spinner, Content, Text, Header, Left, Button, Icon, Title, Body, Right } from "native-base"
...
class Counter extends Component {
  static propTypes = {
    ...
    sellcontract: PropTypes.array.isRequired,
          ...
          <TouchableOpacity onPress={
            ...
            <View hcenter mdpt mdpb >
              <Text style={{
                color: '#999',
                fontSize: 14
              }}>{this.props.contractlist.length > 19 ? '点击加载更多...' : ''}</Text>
            </View>
          </TouchableOpacity>
        }
      </Content>
...
const mapStateToProps = state => ({
  ...
  contractlist: state.house.sellcontract,
