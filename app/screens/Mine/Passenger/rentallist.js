...
import { getClientRent, UpdateClientRent, delClientInfo } from '../../../actions/client'
...
const mapStateToProps = state => ({
  rentlist: state.client.rentlist,

})

export default connect(mapStateToProps, { delClientInfo, getClientRent, UpdateClientRent })(Counter)
