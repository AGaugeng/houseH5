    ...
    return (
      <Container style={styles.container}>
        <Header style={{ backgroundColor: "#fff" }}>
          ...
          <Body>
            <Title style={{ color: "#000" }}>注册</Title>
          </Body>
          <Right />
        </Header>
        <Content>
          ...
          <View style={{ marginTop: 50 }}>
            {this.state.isTrue ?
              ...
              // </Button>
              <TouchableOpacity transparent onPress={() => this.props.RegisterAccount(this.state.password, this.state.confirmpassword, this.state.captcha, this.props.wxstate)} >
                <button
                  transparent
                  className="mine"
                  style={styles.bgColor}
