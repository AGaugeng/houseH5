...
import {
  getCommunity, getHousePrice, addRentalHouse, getHouseType, UpdateSelectLabel, getHouseOrientation, getHouseAge, getHouseFloor, getHouseArea, getHouseUseRights, getHouseLayout, getHouseLabel, getHouseEquipment,
...
class Counter extends Component {
  ...
  addRentalHouse() {
    const { title, province, city, town, address, clicked, kitchen_num, balcony_num, amountm,
      area, floor, room_num, hall_num, bathroom_num, direction, elevator, decoration,
      introduction, construction_time, owner_name, owner_mobile, struct, community, building,
    ...
    return (
      <Container >
        <Header style={{ borderBottomColor: '#E6E6E5', borderBottomWidth: scaleSize(1) }}>
          ...
          <Body>
            <Title style={{ color: '#000' }}>委托出租</Title>
          </Body>
          <Right>
            <Button transparent onPress={() =>
              this.props.navigation.goBack()
              // this.props.navigation.navigate('CommissionSale')
            }>
              <Text style={{ color: '#000', fontSize: 14 }}>售房</Text>
            </Button>
          </Right>
        </Header>
        ...
        <Content style={styles.container}>
          ...
          {this.state.isTrue ?
            <TouchableOpacity transparent onPress={() => this.addRentalHouse()} >
