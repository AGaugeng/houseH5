 ...
 * @LastEditors: Song
 * @LastEditTime: 2018-12-30 12:32:03
 * @Description: IG牛逼
 */
...
class Counter extends Component {
  static propTypes = {
    ...
    traded: PropTypes.array.isRequired,
          ...
          <TouchableOpacity onPress={
            ...
            <View hcenter mdpt mdpb >
              <Text style={{
                color: '#999',
                fontSize: 14
              }}>{this.props.traded.length >= this.state.limit * this.state.page ? '点击加载更多...' : ''}</Text>
            </View>
          </TouchableOpacity>
        }
      </Content>
