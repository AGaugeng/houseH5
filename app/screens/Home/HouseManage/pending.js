 ...
 * @LastEditors: Song
 * @LastEditTime: 2018-12-30 12:31:48
 * @Description: IG牛逼
 */
      ...
      <Content style={styles.section}>
        {this.props.pending.length === 0 ?
          <View style={styles.nocollet}>
            ...
            <Text style={styles.text}>您还没有待审核的房源噢~！</Text>
          </View> :
          <List
            // contentContainerStyle={doctorListStyle.section}
            dataArray={this.props.pending}
          ...
          <TouchableOpacity onPress={
            ...
            <View hcenter mdpt mdpb >
              <Text style={{
                color: '#999',
                fontSize: 14
              }}>{this.props.pending.length >= this.state.limit * this.state.page ? '点击加载更多...' : ''}</Text>
            </View>
          </TouchableOpacity>
        }
      </Content>
