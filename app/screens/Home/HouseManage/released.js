 ...
 * @LastEditors: Song
 * @LastEditTime: 2018-12-30 12:31:55
 * @Description: IG牛逼
 */
          ...
          <TouchableOpacity onPress={
            ...
            <View hcenter mdpt mdpb >
              <Text style={{
                color: '#999',
                fontSize: 14
              }}>{this.props.release.length >= this.state.limit * this.state.page ? '点击加载更多...' : ''}</Text>
            </View>
          </TouchableOpacity>
        }
      </Content>
