...
import {
  searchRentalHouse, getHousePrice, getHouseType, getHouseOrientation, getHouseAge, getHouseFloor, getHouseArea, getHouseUseRights, getHouseLayout, getHouseLabel, getHouseEquipment,
...
class Counter extends Component {
  ...
  searchRentalHouse() {
    let oldLen = this.props.rentalhouse.length
    ...
    this.props.searchRentalHouse([
      ...
      let newLen = this.props.rentalhouse.length
      if (oldLen === newLen) {
  ...
  render() {
    ...
    const amountm = [
      { id: 2, title: "0到1000", min: 0, max: 1000 },
      { id: 3, title: "1000到2000", min: 1000, max: 2000 },
      { id: 4, title: "2000到3000", min: 2000, max: 3000 },
      { id: 5, title: "3000以上", min: 3000, max: 99999999999999 }]
    ...
    return (
      <Container style={styles.container}>
        ...
        <Content>
                  ...
                  <View>
                    {this.props.price.length !== 0 && <View style={{ flexWrap: 'wrap' }} row vcenter hcenter mdpt>
                      {[
                        ...
                        { id: 3, title: "1000到2000", min: 1000, max: 2000 },
                        { id: 4, title: "2000到3000", min: 2000, max: 3000 },
                        { id: 5, title: "3000以上", min: 3000, max: 99999999999999 }].map((item, index) =>
                    ...
                    <Grid style={{ alignSelf: 'center', marginTop: scaleSize(50) }}>
                      ...
                      <Col>
                        <Button style={{ justifyContent: 'center', marginLeft: scaleSize(34), width: scaleSize(306), height: scaleSize(80), borderRadius: scaleSize(40), backgroundColor: '#e64e37' }}
                          onPress={() => {
                            this.props.searchRentalHouse([
                              { name: 'amountm', data: amountm[this.props.selectprice].min + ',' + amountm[this.props.selectprice].max },
                              { name: 'page', data: this.state.page },
                              { name: 'limit', data: this.state.limit },
                    ...
                    <View>
                      ...
                      {this.props.housetype.length !== 0 && <View style={{ flexWrap: 'wrap' }} row vcenter hcenter >
                        {this.props.housetype.map((item, index) =>
                          <Button small key={index} style={{ margin: scaleSize(10), backgroundColor: this.props.selecthousetype === index ? '#e64e37' : '#f4f4f4' }}
          ...
          {this.props.rentalhouse.length === 0 ?
            <View vcenter hcenter xlp>
            ...
            <List
              ...
              dataArray={this.props.rentalhouse}
...
export default connect(mapStateToProps, {
  searchRentalHouse, getAreaBrother,
