...
import { getArticleDetail } from "../../../../actions/user"
...
class Counter extends Component {
  ...
  render() {
    ...
    const rule = this.state.protocol
    return (
      <Container style={{ backgroundColor: '#fff' }}>
        <Header style={{ backgroundColor: '#e64e37' }}>
          ...
          <Body>
            <Title style={{ color: '#fff' }}>资讯详情</Title>
          </Body>
          <Right />
        ...
        <View mdp>
          <Text> <div style={{ width: deviceWidth, height: deviceHeight }} dangerouslySetInnerHTML={{ __html: this.props.detail.content }}></div></Text>
        </View>
...
const mapStateToProps = state => ({
  detail: state.user.articledetail
})
